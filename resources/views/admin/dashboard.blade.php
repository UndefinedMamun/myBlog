...
<html lang="en">
<head>
<title>Dashboard of {{Session::get('admin_name')}}</title>
<meta charset="UTF-8" />
...
<link rel="stylesheet" href="{{asset('public/admin/css/jquery.gritter.css')}}" />
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">{{Session::get('admin_name')}}</span><b class="caret"></b></a>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Category</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="{{url('/add-main-category')}}">Add Main Category</a></li>
        <li><a href="{{url('/manage-main-category')}}">Manage Main Category</a></li>
        <li><a href="{{url('/add-sub-category')}}">Add Sub-Category</a></li>
        <li><a href="{{url('/manage-sub-category')}}">Manage Sub-Category</a></li>
      </ul>
    </li>
    <li><a href="{{url('/add-post')}}"><i class="icon icon-th"></i> <span>Add Post</span></a></li>
    <li><a href="{{url('/manage-post')}}"><i class="icon icon-fullscreen"></i> <span>Manage Post</span></a></li>
    <li> <a href="{{url('/manage-comments')}}"><i class="icon icon-signal"></i> <span>Manage Comments</span></a> </li>
    <li> <a href="{{url('/manage-category')}}"><i class="icon icon-inbox"></i> <span>Manage Main Category</span></a> </li>
...
<script src="{{asset('public/admin/js/matrix.interface.js')}}"></script> 
<script src="{{asset('public/admin/js/matrix.chat.js')}}"></script> 
<script src="{{asset('public/admin/js/jquery.validate.js')}}"></script> 
<script src="{{asset('public/admin/js/matrix.form_validation.js')}}"></script> 
<script src="{{asset('public/admin/js/jquery.wizard.js')}}"></script> 
<script src="{{asset('public/admin/js/jquery.uniform.js')}}"></script> 
<script src="{{asset('public/admin/js/select2.min.js')}}"></script> 
<script src="{{asset('public/admin/js/matrix.popover.js')}}"></script> 
